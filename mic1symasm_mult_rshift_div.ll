...
#define		LOC	  28
#define		STR	  29
#define		MULT	  30		// Adding MULT Instruction
#define		RSHIFT	  31		// Adding RSHIFT Instruction
#define 	DIV 	  32		// Adding DIV Instruction
%}
...
[Mm][Uu][Ll][Tt]                       return(MULT);		// return MULT for the symbol table switch statement

[Rr][Ss][Hh][Ii][Ff][Tt]               return(RSHIFT);		// return RSHIFT for the symbol table switch statement

[Dd][Ii][Vv]                           return(DIV);		// return DIV for the symbol table switch statement
